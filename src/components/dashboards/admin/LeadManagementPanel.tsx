          ...
          const demoLeads: Lead[] = [
            {
              ...
              station: 'Processing Line A',
              email: 'mjohnson@clamflow.com',
              phone: '+1-555-0123',
              status: 'active',
              hire_date: '2023-03-15',
              last_login: '2025-08-29T06:30:00Z',
              performance_score: 92,
              team_size: 12,
              current_shift: 'Morning (6AM-2PM)',
              achievements: ['Best Team Performance Q2', 'Safety Excellence Award'],
              metrics: {
                tasks_completed: 156,
                team_efficiency: 94,
                quality_score: 91,
            ...
            {
              id: '2',
              username: 'QC_Williams',
              full_name: 'Sarah Williams',
              role: 'QC Lead',
              department: 'Quality Control',
              station: 'QC Lab',
              email: 'swilliams@clamflow.com',
              phone: '+1-555-0124',
              status: 'active',
              hire_date: '2022-11-08',
              last_login: '2025-08-29T05:45:00Z',
              performance_score: 96,
              team_size: 8,
              current_shift: 'Day (8AM-4PM)',
              achievements: ['Quality Excellence Q1', 'Innovation Award 2024'],
              metrics: {
                tasks_completed: 203,
                team_efficiency: 97,
                quality_score: 99,
            ...
            },
            {
              ...
              station: 'Packaging Area B',
              email: 'dbrown@clamflow.com',
              phone: '+1-555-0125',
              status: 'active',
              hire_date: '2023-01-20',
              last_login: '2025-08-29T07:15:00Z',
              performance_score: 88,
              team_size: 15,
              current_shift: 'Afternoon (2PM-10PM)',
              achievements: ['Team Leadership Award'],
              metrics: {
                tasks_completed: 134,
                team_efficiency: 89,
                quality_score: 87,
            ...
            },
            {
              ...
              role: 'Shift Lead',
              department: 'Processing',
              station: 'Processing Line B',
              email: 'edavis@clamflow.com',
              phone: '+1-555-0126',
              status: 'on_leave',
              hire_date: '2023-07-12',
              last_login: '2025-08-27T16:20:00Z',
              performance_score: 85,
              team_size: 10,
              current_shift: 'Night (10PM-6AM)',
              achievements: ['Night Shift Excellence'],
              metrics: {
                tasks_completed: 98,
                team_efficiency: 86,
                quality_score: 84,
            ...
            },
            {
              ...
              role: 'QC Lead',
              department: 'Quality Control',
              station: 'QC Testing Station',
              email: 'cmartinez@clamflow.com',
              phone: '+1-555-0127',
              status: 'active',
              hire_date: '2023-05-03',
              last_login: '2025-08-29T06:10:00Z',
              performance_score: 90,
              team_size: 6,
              current_shift: 'Evening (4PM-12AM)',
              achievements: ['Process Improvement Award'],
              metrics: {
                tasks_completed: 167,
                team_efficiency: 91,
                quality_score: 93,
